...
public class DeviceListActivity extends Activity {
    ...
    private void checkBTState() {
        ...
        if(mBtAdapter == null) {
            Toast.makeText(getBaseContext(), "Fatal Error" + " - " + "Bluetooth Not supported. Aborting.", Toast.LENGTH_SHORT);
        } else {
        ...
        switch (requestCode) {
            case REQUEST_ENABLE_BT:
                if (resultCode == Activity.RESULT_OK) {
                    Intent refresh = new Intent(getApplicationContext(), DeviceListActivity.class);
                    finish();
